...
- **Diagnostics replay**: import `.json` / `.json.gz` bundles via drag-and-drop or file picker to inspect summaries locally, and explore logs/errors with query/level filters and expandable details (no upload).
