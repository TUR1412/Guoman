...
| Diagnostics         | 控制台健康全景图 + UI 诊断页（可导出诊断包）                              | ✅稳定 | `src/utils/healthConsole.js`<br/>`src/utils/buildInfo.js`<br/>`src/utils/diagnosticsBundle.js`<br/>`src/pages/DiagnosticsPage.jsx`<br/>`src/components/AppErrorBoundary.jsx`<br/>`src/components/ManualCopyDialog.jsx` |
