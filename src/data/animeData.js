...
const animeData = [
  {
    ...
    rating: 4.7,
    studio: '玄机科技',
    description: '唐门外门弟子唐三，因偷学内门绝学《玄天功》被师父逐出师门，为了唐门的荣誉，他决定深入"诺丁学院"学习。唐三在学院里结识了小舞、戴沐白、奥斯卡、马红俊、宁荣荣、朱竹清等人，并想办法进入了"史莱克学院"。随着唐三武魂觉醒异常，他意识到自己肩负的使命，以及牵扯在她一家身上的千年仇恨。',
    tags: ['玄幻', '武侠', '热血', '战斗'],
    popularity: 9800,
  ...
  },
  {
    ...
    rating: 4.9,
    studio: '绘梦动画',
    description: '天官赐福讲述了已成仙的前太子谢怜与神秘的鬼王花城之间的冒险故事。谢怜三次成神，三次被贬，在第三次成为天官后，他不慎遇到了一个自称是他的头号粉丝的鬼王。故事围绕着谢怜解开自己的前世之谜，以及与花城的感情发展展开。',
    tags: ['古风', 'BL', '奇幻', '冒险'],
    popularity: 9500,
  ...
  },
  {
    ...
    rating: 4.8,
    studio: '绘梦动画',
    description: '围绕着云梦江氏的少主魏无羡与姑苏蓝氏的二公子蓝忘机展开的一段啼笑皆非的仙侠传奇。魏无羡因机缘巧合，重生到一个自甘堕落的修士身上，开始了一段寻回真相的旅程。',
    tags: ['古风', '仙侠', '悬疑', '情感'],
    popularity: 9600,
  ...
  },
  {
    ...
    rating: 4.6,
    studio: '彩色铅笔',
    description: '网游荣耀中被誉为教科书级别的顶尖高手叶修，因为种种原因遭到俱乐部的驱逐，离开职业圈的他被兴欣网吧收留，然而随着荣耀十区的开启，他重新回到了职业之巅。',
    tags: ['电竞', '游戏', '团队', '励志'],
    popularity: 9300,
  ...
  },
  {
    ...
    rating: 4.5,
    studio: '艺画开天',
    description: '未来世界，地球环境剧变，人类被迫生活在塔内避难所"三十三号城市"中。外围满是巨型怪物，塔内则有三大势力角力：联合政府、企业联合体与天选者。故事围绕着主角标记为"麒"的男子，从三十三号城市下层前往地面的旅途中所展开。',
    tags: ['科幻', '末世', '机甲', '悬疑'],
    popularity: 8900,
  ...
  },
  {
    ...
    description: '《大理寺日志》讲述了唐朝大理寺的小官员李饼，奉命与法医宋不悲、女捕快白情儿，一起破获各种离奇案件的故事。李饼虽不会武功，但智慧过人，善于观察，屡屡靠理性推理解决危机。',
    tags: ['古风', '推理', '悬疑', '喜剧'],
    popularity: 8500,
  ...
  },
  {
    ...
    rating: 4.4,
    studio: '刘阔工作室',
    description: '普通上班族夏铃在一次意外中wanderer，被卷入了守护灵体的战斗。为了查明真相，她来到了镇魂街，并在这里遇到了拥有"双守护灵"的少年曹焱兵。两人一起，卷入了一场关乎镇魂街存亡的战斗中。',
    tags: ['热血', '都市', '灵异', '战斗'],
    popularity: 9100,
  ...
  },
  {
    ...
    rating: 4.5,
    studio: '玄机科技',
    description: '《武庚纪》的故事发生在神话时代，各部落蒸蒸日上，种族林立，争斗不断。武庚因对神之手政策不满，被神所杀，灵魂转生到孤儿武日身上，开始了复仇之路，并揭开了更大的阴谋。',
    tags: ['玄幻', '神话', '热血', '复仇'],
    popularity: 9000,
  ...
  },
  {
    ...
    rating: 4.6,
    studio: '中影年年',
    description: '普通少年韩立为求修仙长生，历经种种艰险、背叛、打压，在修仙界攀登巅峰的故事。从默默无闻到一跃成为修仙界的传奇，韩立的经历充满了生存危机与成长。',
    tags: ['修仙', '冒险', '奇幻', '成长'],
    popularity: 8800,
  ...
  },
  {
    ...
    rating: 4.8,
    studio: '六道无鱼',
    description: '《雾山五行》讲述了生活在"神秘瘴气"笼罩的雾山之中的少数民族"苗民"，为了驱散瘴气，保护族人，以"五行"的力量与瘴气背后的邪恶"神"展开一场旷世大战的故事。',
    tags: ['武侠', '五行', '民族风', '战斗'],
    popularity: 9200,
  ...
  },
  {
    ...
    rating: 4.7,
    studio: '啊哈娱乐',
    description: '这是一部以爆笑为主题的动画，讲述了一个想要隐姓埋名的刺客——伍六七，在边境小镇开理发店的故事。由于身手了得，他被许多人追杀，只能一边打工一边保命，在生死边缘中寻求真相。',
    tags: ['搞笑', '热血', '动作', '悬疑'],
    popularity: 9400,
  ...
  },
  {
    ...
    rating: 4.3,
    studio: '腾讯视频',
    description: '《元龙》讲述了特种兵王胜被一道神秘的雷电劈中后穿越到异世界，并附身到另一个叫做王胜的少年体内。在这个异世界中，家族与个人的力量至上，王胜不得不依靠现代知识与军事素养，从一个懦弱少年逐渐成长为强者的故事。',
    tags: ['穿越', '异世界', '战斗', '成长'],
    popularity: 8700,
